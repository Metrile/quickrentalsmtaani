...
<li id="applink"><a href="header.html"target="_blank="title="Back about"id="link">about</a></li>
...
<body>
	...
	<form id="login_form">
		...
		<input type="text" name=""><br>
		<br><input type="submit"name="" value="Sign up"><br>
	</form>
...
<body>
	...
	<form>
		...
		<input type="text" name=""><br>
		<br><input type="submit"name="" value="Log in"><br>
	</form>
	<!-- <end login setion -->
	<!-- <start 2nd section	 -->
